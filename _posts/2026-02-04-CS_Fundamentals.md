...
<h6 style="margin-bottom:6px">마스킹(Masking)</h6>
비트 패턴을 왼쪽, 오른쪽으로 밀어내는 연산을 의미합니다.
   
<h6 style="margin-bottom:6px">논리적 시프트(Logical Shift)</h6>
빈 공간을 0으로 채우는 방식입니다.
   
<h6 style="margin-bottom:6px">산술적 시프트(Arithmetic Shift)</h6>
